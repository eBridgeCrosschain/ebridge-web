...
const googleReCaptchaModal = async (width?: number): Promise<TGoogleReCaptchaResult | undefined | any> => {
  ...
  return new Promise((resolve, reject) => {
    const modal = Modal.info({
      closable: true,
      closeIcon: <CloseIcon />,
      wrapClassName: 'ebridge-web-reCaptcha-modal-wrapper',
      className: 'ebridge-web-reCaptcha-modal-container',
      width: width,
